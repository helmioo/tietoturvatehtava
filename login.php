...
if (isset($_SERVER['PHP_AUTH_USER'])) {
    ...
    if (checkUser(openDb(), $_SERVER['PHP_AUTH_USER'], $_SERVER["PHP_AUTH_PW"])) {
        ...
        //Käyttäjä tunnistettu, luodaan vastaukseen JWT token payload
        $payload = array(
            "iat" => time(),
        ...
        //Lähetetään JSONina infoteksti ja JWT token clientille
...
//Login ei onnistunut, palautetaan unauhtorized-otsikko sekä info epäonnistumisesta
